...
/**
 * <A href="http://www.atomikos.com">Atomikos</A>, the company, sell products and support around transaction
 * management. They offer a very handy open-source package called TransactionEssentials, which is what Spring Boot integrates.
 * <p>
 * This implementation uses the very convenient {@code org.springframework.boot:spring-boot-starter-jta-atomikos} starter to
 * bring in the right types for Atomikos's core JTA support as well
 * as its JDBC ({@code com.atomikos:transactions-jdbc}) and JMS support ({@code com.atomikos:transactions-jms})
 *
 * @author Josh Long
 */
@Configuration
...
public class SampleAtomikosApplication {
     ...
     * The {@link com.atomikos.jdbc.AtomikosDataSourceBean}
     * expects a reference to a {@link javax.sql.XADataSource}.
     */
    ...
    /**
     * The Atomikos project provide a wrapper {@link javax.jms.ConnectionFactory} implementation.
     * The {@link com.atomikos.jms.AtomikosConnectionFactoryBean}
     * expects a reference to a {@link javax.jms.XAConnectionFactory}.
     */
    @Bean(initMethod = "init", destroyMethod = "close")
