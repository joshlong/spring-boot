 ...
 * configures JTA support. Requires that clients register their
 * {@link javax.sql.DataSource}s with {@link com.atomikos.jdbc.AtomikosDataSourceBean} and
 * their JMS {@link javax.jms.ConnectionFactory}s with
...
class AtomikosJtaAutoConfiguration {
	//
	// public static final String USER_TRANSACTION_SERVICE =
	// "atomikosUserTransactionService";
	//
	// @ConditionalOnMissingBean
	// @Bean(name = USER_TRANSACTION_SERVICE, initMethod = "init", destroyMethod =
	// "shutdownForce")
	...
	// }
	//
	// // TODO The UserTransactionManager must start *after* the pools are initialized and
	// be
