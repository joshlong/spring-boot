...
/**
 * wraps the {@link com.arjuna.ats.jdbc.TransactionalDriver} implementation that JBoss TM
 * already ships with as a generic, XA-aware {@link javax.sql.DataSource}.
 *
 * @author Josh Long
 */
public class ArjunaXaDataSourceFactoryBean implements BeanNameAware,
	...
	/**
	 * This will be passed into the {@link com.arjuna.ats.internal.jdbc.DynamicClass}
	 * <em>driver</em>
	 */
	 ...
	 * need to provide this instead of a simple {@link javax.sql.DataSource} reference,
	 * but here it is.
	 * <p>
	 * We store all {@link javax.sql.DataSource} beans in the {@link #XA_DATA_SOURCE_MAP}
	 * map and key them by <code>beanName</code>. That <code>beanName</code> is then
	 * passed as a property into the {@link com.arjuna.ats.jdbc.TransactionalDriver} which
	 * then looks the bean up by asking the
	 * {@link com.arjuna.ats.internal.jdbc.DynamicClass} implementation. In this case,
	 * that implementation just looks the bean up in the map.
	 */
	...
	public ArjunaXaDataSourceFactoryBean(XADataSource xaDataSource, String username,
			String password) {
	...
	public DataSource getObject() throws Exception {
		XA_DATA_SOURCE_MAP.put(this.beanName, this.xaDataSource);
		...
		properties.setProperty(TransactionalDriver.dynamicClass,
				this.dynamicClass.getName());
		String url = TransactionalDriver.arjunaDriver + "" + this.beanName;
		SimpleDriverDataSource simpleDriverDataSource = new SimpleDriverDataSource(
				transactionalDriver, url, properties);
